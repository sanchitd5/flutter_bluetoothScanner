...
class ScanResultTile extends StatelessWidget {
  ...
  void startServiceInPlatform(device) async {
    if (Platform.isAndroid) {
      var methodChannel = MethodChannel("com.messages");

      String data =
          await methodChannel.invokeMethod("startService", <String, dynamic>{
        "Name": "H 1",
        "ID": "F8:F0:05:EB:DA:73",
        "Service": "688ee5ce-0800-4e99-b278-a290e6da388f",
        "Characteristic": "57a343ea-26d1-4104-8de4-7706115a21bd",
        // "Device": device
      });
      debugPrint(data);
    }
  ...
  void startServiceInPlatform() async {
    if (Platform.isAndroid) {
      ...
      String data = await methodChannel.invokeMethod(
          "startService", <String, String>{"Name": "Name1", "UUID": "UUID1"});
      debugPrint(data);
    }
  }
